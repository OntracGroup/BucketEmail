...
def generate_pdf(side_by_side_df, loadout_productivity_df, swings_simulation_df, improved_cycle_df):
    ...
    side_by_side_table = Table(side_by_side_table_data, colWidths='*')
    ...
    swings_simulation_table = Table(swings_simulation_table_data, colWidths='*')
    ...
    improved_cycle_table = Table(improved_cycle_table_data, colWidths='*')
